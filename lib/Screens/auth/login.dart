...
class Login extends StatelessWidget {
  ...
  static const your_client_id = '459625749487684';

  final FirebaseAuth _auth = FirebaseAuth.instance;
  static const your_redirect_url =
      'https://relatesa-fedeb.firebaseapp.com/__/auth/handler';
  ...
  Future navigationCheck(User currentUser, context) async {
    ...
    await FirebaseFirestore.instance
      ...
      if (snapshot.docs.isNotEmpty) {
        if (snapshot.docs.first.data().toString().contains('location')) {
