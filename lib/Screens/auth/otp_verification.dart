            ...
            InkWell(
              ...
              onTap: () async {
                ...
                if (widget.updateNumber) {
                  ...
                  print('hello');
                  var userCrd = await FirebaseAuth.instance
                      .signInWithCredential(_phoneAuth);
                 await FirebaseFirestore.instance
                      .collection('Users')
                      .where('userId', isEqualTo: userCrd.user!.uid)
                      .get()
                      .then((QuerySnapshot snapshot) async {
                    if (snapshot.docs.length <= 0) {
                      await setDataUser(userCrd.user!);
                    }
                  });
                  ...
                  return showDialog(
                      ...
                      builder: (_) {
                        Future.delayed(Duration(seconds: 2), () async {
                          ...
                          Navigator.pop(context);
                          await _login.navigationCheck(userCrd.user!, context);
                        });
                        return Center(
                            child: Container(
                                width: 180.0,
