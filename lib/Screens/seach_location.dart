...
import 'package:hookup4u/Screens/mapbox/mapbox_search_places.dart';
import 'package:hookup4u/Screens/mapbox/predictions.dart';
import 'package:hookup4u/Screens/mapbox_autocomplete.dart';
...
String mapboxApi =
    "pk.eyJ1IjoicmVsYXRlc2ExIiwiYSI6ImNsZHNqNnZpZzBvN2czb3BjZzZxMzJiNWsifQ.G0pXn7VhXHHEeVJr4xIN1Q";
                    ...
                    Padding(
                      ...
                      child: TextField(
                        ...
                        onTap: () => Navigator.push(
                            context,
                            MaterialPageRoute(
                                builder: (context) => MapBoxPlaceSearchWidget(
                                      popOnSelect: true,
                                      apiKey: mapboxApi,
                                      // limit: 10,
                          ...
                          child: InkWell(
                            ...
                            onTap: () {
                              CustomSnackbar.showSnackBar(
                                context: context,
                                text: "Select a location !".tr().toString(),
                              );
                            },
                          ),
                        ),
