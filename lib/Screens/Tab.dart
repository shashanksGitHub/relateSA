...
class Tabbar extends StatefulWidget {
  ...
  final String? plan;
  bool? isPurchased;
  Tabbar(this.plan, this.isPaymentSuccess, {this.isPurchased});
  @override
...
class TabbarState extends State<Tabbar> {
    ...
    if (currentUser!.showGender == 'everyone') {
      ...
      return docRef
          ...
          .where(('myInterest.interest'),
              arrayContainsAny: currentUser!.searchInterest);
      //      .orderBy('age', descending: false);
    }
  }
  ...
  //   print('::::::::::::::::::::::::::');
  //   if (true) {
  //     return docRef.where(('searchInterest.interest'),
  //         arrayContainsAny: currentUser!.myInterest);
  //   }
  //   // else {
  //   //   return docRef
  //   //       .where('editInfo.userGender', isEqualTo: currentUser!.showGender)
  ...
  isUserHaveSubscription() async {
    print('isUserHaveSubscription');
    Purchases.addCustomerInfoUpdateListener((customerInfo) async {
      final purchaserInfo = await Purchases.getCustomerInfo();
      final entiltementInfo = purchaserInfo.entitlements.active.values.toList();
      if (entiltementInfo.isNotEmpty) {
        isPuchased = true;
      } else {
        isPuchased = false;
      }
      setState(() {});
      print('lode tere lagnge $isPuchased');
    });
  }
                    ...
                    child: Scaffold(
                        ...
                        body: TabBarView(
                          children: [
                            Center(
                                child:
                                    Profile(currentUser!, isPuchased, items)),
                            Center(
                                child: CardPictures(
