...
// import 'mapbox/location.dart';
// import 'mapbox/predictions.dart';
// import 'mapbox/text_editing_controller.dart';
...
//           'https://api.mapbox.com/geocoding/v5/mapbox.places/$input.json?access_token=pk.eyJ1IjoicmVsYXRlc2ExIiwiYSI6ImNsZHNqNnZpZzBvN2czb3BjZzZxMzJiNWsifQ.G0pXn7VhXHHEeVJr4xIN1Q&autocomplete=true&language=en&limit=10'));
//       // 'https://api.mapbox.com/geocoding/v5/mapbox.places/d.json?access_token=pk.eyJ1IjoicmVsYXRlc2ExIiwiYSI6ImNsZHNqNnZpZzBvN2czb3BjZzZxMzJiNWsifQ.G0pXn7VhXHHEeVJr4xIN1Q&cachebuster=1566806258853&autocomplete=true&language=en&limit=10'));
//       print(
//           'hereee ${"https://api.mapbox.com/geocoding/v5/mapbox.places/$input.json?access_token=${widget.apiKey}&autocomplete=true&language=${widget.language}&limit=${widget.limit}"}');
