...
final List adds = [
  ...
  },
  {
    ...
    'subtitle': "Passport to anywhere!".tr().toString(),
  },
  {
    'icon': Icons.vpn_key,
    'color': Colors.orange,
...
class Profile extends StatefulWidget {
  ...
  final Map items;
  Profile(this.currentUser, this.isPuchased, this.items);
          ...
          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: <
            ...
            Padding(
              ...
              child: InkWell(
                ...
                onTap: () {
                  fetchOffers();
                  //await Purchases.purchasePackage("monthly_");
            ...
            child: Center(
              ...
              itemBuilder: (context, index) {
                return Card(
                  ...
                  child: ListTile(
                    onTap: () async {
                      await Purchases.purchasePackage(packages[index]);
                    },
                    title: Text(packages[index].storeProduct.title),
                    subtitle: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
                      children: [
                        Text(packages[index].storeProduct.description),
                        //Text(e.storeProduct.currencyCode),
                        Text(packages[index].storeProduct.identifier),
                        Text(packages[index].storeProduct.priceString),
                        //Text(e.storeProduct.discounts.toString()),
                        // Text(e.storeProduct.introductoryPrice
                        //  .toString()),
                        // Text(e.storeProduct.price.toString()),
                      ],
                    ),
                  ),
                );
